        ...
        <div class="container">
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" id="validasi" action="product.html">
                            <div class="col-md-6">
                                <label for="harga" class="form-label">Harga Sewa</label>
                                <input type="text" class="form-control" id="harga" value="{{ $data->hargasewa }}"
                                    readonly />
                            </div>
                            <div class="col-md-6">
                                <label for="nim" class="form-label">Denda Keterlambatan / perjam</label>
                                <input type="text" class="form-control" id="nim" value="{{ $data->hargasewa }}"
                                    readonly />
                            </div>
                            <div class="col-md-6">
